<?php
/**
 * Register the Dailymotion Embed element for WPBakery.
 *
...
add_action(
	'vc_before_init',
	function () {
		require_once __DIR__ . '/class-sefwpb-element-dailymotion-embed.php';

		vc_map(
			[
				'name'        => esc_html__( 'Dailymotion Embed', 'social-elements-for-wpbakery' ),
				'base'        => 'sefwpb_dailymotion_embed',
				'description' => esc_html__( 'Embed Dailymotion video', 'social-elements-for-wpbakery' ),
				'category'    => esc_html__( 'Social', 'social-elements-for-wpbakery' ),
				'icon'        => SEFWPB_ASSETS_URI . '/images/icons/icon-dailymotion-embed.svg',
				'params'      => [
					[
						'type'        => 'textfield',
					...
					[
						'type'        => 'textfield',
						'heading'     => esc_html__( 'Dailymotion URL', 'social-elements-for-wpbakery' ),
						'param_name'  => 'url',
						'description' => esc_html__( 'Enter the URL of the Dailymotion video you want to embed.', 'social-elements-for-wpbakery' ),
						'value'       => 'https://www.dailymotion.com/video/x7tgczq',
					],
					[
						'type'       => 'dropdown',
					...
					[
						...
						'param_name'  => 'width',
						'group'       => esc_html__( 'Styles', 'social-elements-for-wpbakery' ),
						'description' => esc_html__( 'Optional. Enter width of the embedded video in pixels or percentage. Default is 100%.', 'social-elements-for-wpbakery' ),
						'value'       => '100%',
					],

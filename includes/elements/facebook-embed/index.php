<?php
/**
 * Register the Facebook Embed element for WPBakery.
 *
...
add_action(
	...
	function () {
		...
		vc_map(
			[
				'name'        => esc_html__( 'Facebook Embed', 'social-elements-for-wpbakery' ),
				'base'        => 'sefwpb_facebook_embed',
				'description' => esc_html__( 'Embed a single Facebook post', 'social-elements-for-wpbakery' ),
				...
				'params'      => [
					...
					[
						'type'        => 'textfield',
						'heading'     => esc_html__( 'Facebook Post URL', 'social-elements-for-wpbakery' ),
						'param_name'  => 'url',
						'description' => esc_html__( 'Enter the URL of the Facebook post you want to embed. Example: https://www.facebook.com/100064860875397/posts/10154009990506729/', 'social-elements-for-wpbakery' ),

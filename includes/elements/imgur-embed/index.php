<?php
/**
 * Register the Imgur Embed element for WPBakery.
 *
...
add_action(
	'vc_before_init',
	function () {
		require_once __DIR__ . '/class-sefwpb-element-imgur-embed.php';

		vc_map(
			[
				'name'        => esc_html__( 'Imgur Embed', 'social-elements-for-wpbakery' ),
				'base'        => 'sefwpb_imgur_embed',
				'description' => esc_html__( 'Embed Imgur post', 'social-elements-for-wpbakery' ),
				'category'    => esc_html__( 'Social', 'social-elements-for-wpbakery' ),
				'icon'        => SEFWPB_ASSETS_URI . '/images/icons/icon-imgur-embed.svg',
				'params'      => [
					[
						'type'        => 'textfield',
					...
					[
						'type'        => 'textfield',
						'heading'     => esc_html__( 'Imgur URL', 'social-elements-for-wpbakery' ),
						'param_name'  => 'url',
						'description' => esc_html__( 'Enter the URL of the Imgur post you want to embed.', 'social-elements-for-wpbakery' ),
						'value'       => 'https://i.imgur.com/4XfZlRA.jpeg',
					],
					[
						'type'       => 'dropdown',

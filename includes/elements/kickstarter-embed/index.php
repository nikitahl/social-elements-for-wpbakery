<?php
/**
 * Register the Kickstarter Embed element for WPBakery.
 *
...
add_action(
	'vc_before_init',
	function () {
		require_once __DIR__ . '/class-sefwpb-element-kickstarter-embed.php';

		vc_map(
			[
				'name'        => esc_html__( 'Kickstarter Embed', 'social-elements-for-wpbakery' ),
				'base'        => 'sefwpb_kickstarter_embed',
				'description' => esc_html__( 'Embed Kickstarter project', 'social-elements-for-wpbakery' ),
				'category'    => esc_html__( 'Social', 'social-elements-for-wpbakery' ),
				'icon'        => SEFWPB_ASSETS_URI . '/images/icons/icon-kickstarter-embed.svg',
				'params'      => [
					[
						'type'        => 'textfield',
					...
					[
						'type'        => 'textfield',
						'heading'     => esc_html__( 'Kickstarter URL', 'social-elements-for-wpbakery' ),
						'param_name'  => 'url',
						'description' => esc_html__( 'Enter the URL of the Kickstarter project you want to embed.', 'social-elements-for-wpbakery' ),
						'value'       => 'https://www.kickstarter.com/projects/',
					],
					[
						'type'       => 'dropdown',

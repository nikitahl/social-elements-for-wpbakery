<?php
/**
 * Register the Mixcloud Embed element for WPBakery.
 *
...
add_action(
	'vc_before_init',
	function () {
		require_once __DIR__ . '/class-sefwpb-element-mixcloud-embed.php';

		vc_map(
			[
				'name'        => esc_html__( 'Mixcloud Embed', 'social-elements-for-wpbakery' ),
				'base'        => 'sefwpb_mixcloud_embed',
				'description' => esc_html__( 'Embed Mixcloud audio', 'social-elements-for-wpbakery' ),
				'category'    => esc_html__( 'Social', 'social-elements-for-wpbakery' ),
				'icon'        => SEFWPB_ASSETS_URI . '/images/icons/icon-mixcloud-embed.svg',
				'params'      => [
					[
						'type'        => 'textfield',
					...
					[
						'type'        => 'textfield',
						'heading'     => esc_html__( 'Mixcloud URL', 'social-elements-for-wpbakery' ),
						'param_name'  => 'url',
						'description' => esc_html__( 'Enter the URL of the Mixcloud show you want to embed.', 'social-elements-for-wpbakery' ),
						'value'       => 'https://www.mixcloud.com/Mixcloud/mixcloud-selects-001/',
					],
					[
						'type'       => 'dropdown',

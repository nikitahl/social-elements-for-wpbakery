...
add_action(
	...
	function () {
		...
		vc_map(
			[
				'name'        => esc_html__( 'Pinterest Embed', 'social-elements-wpbakery' ),
				'base'        => 'sefwpb_pinterest_embed',
				'description' => esc_html__( 'Embed a single Pinterest post', 'social-elements-wpbakery' ),
				...
				'params'      => [
					...
					[
						'type'        => 'textfield',
						'heading'     => esc_html__( 'Pinterest Post URL', 'social-elements-wpbakery' ),
						'param_name'  => 'url',
						'description' => esc_html__( 'Enter the URL of the Pinterest post you want to embed. Example: https://www.pinterest.com/pin/3940718420141988/', 'social-elements-wpbakery' ),

...
add_action( 'vc_before_init', function () {
	...
	vc_map(
		[
			'name'        => esc_html__( 'Social Share Buttons', SEFWPB_TD ),
			...
			'params'      => [
				[
					'type' => 'textfield',
					'heading' => esc_html__('Share Title', SEFWPB_TD),
					'value' => esc_html__('Share this:', SEFWPB_TD),
					'param_name' => 'share_title',
					'description' => esc_html__('Optional. Used before the buttons to incidate that these are share buttons', SEFWPB_TD),
				],
				[
					'type' => 'param_group',
					'heading' => esc_html__( 'Share buttons', SEFWPB_TD ),
					'param_name' => 'values',
					'description' => esc_html__( 'Enter values for button - title, icon, color.', SEFWPB_TD ),
					'value' => rawurlencode( wp_json_encode( [
						...
						[
							'label' => esc_html__( 'Linkedin', SEFWPB_TD ),
						...
						[
							'label' => esc_html__( 'Reddit', SEFWPB_TD ),
						...
						[
							'label' => esc_html__( 'Email', SEFWPB_TD ),
					...
					'params' => [
						[
							'type' => 'dropdown',
							'heading' => esc_html__( 'Social platform', SEFWPB_TD ),
							'value' => [
								esc_html__( 'Facebook', SEFWPB_TD ) => 'facebook',
								esc_html__( 'X (Twitter)', SEFWPB_TD ) => 'x',
								esc_html__( 'Linkedin', SEFWPB_TD ) => 'linkedin',
								esc_html__( 'Reddit', SEFWPB_TD ) => 'reddit',
								esc_html__( 'Pinterest', SEFWPB_TD ) => 'pinterest',
							...
							'description' => esc_html__( 'Select social media platform to share on.', SEFWPB_TD ),
						],
						[
							'type' => 'textfield',
							'heading' => esc_html__( 'Label', SEFWPB_TD ),
							'param_name' => 'label',
							'description' => esc_html__( 'Enter text used as title of button.', SEFWPB_TD ),
						],
						[
							'type' => 'colorpicker',
							'heading' => esc_html__( 'Color', SEFWPB_TD ),
							'param_name' => 'color',
							'description' => esc_html__( 'Select button color.', SEFWPB_TD ),
						],
						[
							'type' => 'dropdown',
				...
				[
					...
					'value' => [
						...
						esc_html__( 'Minimal (text only)', SEFWPB_TD ) => 'minimal',
					],
					'std' => 'solid',
				],
				[
					...
					'description' => esc_html__( 'Optional. Set custom text color in.', SEFWPB_TD ),
					'value' => '#0a0b0e',
					'dependency' => [
						'element' => 'style',
						'value' => [ 'minimal' ],
				...
				[
					'type' => 'textfield',
					'heading' => esc_html__( 'Button gap', SEFWPB_TD ),
					'param_name' => 'gap',
					'group' => esc_html__( 'Styles', SEFWPB_TD ),
					'value' => '5px',
				],

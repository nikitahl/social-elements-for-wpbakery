<?php
/**
 * Register the SoundCloud Embed element for WPBakery.
 *
...
add_action(
	'vc_before_init',
	function () {
		require_once __DIR__ . '/class-sefwpb-element-soundcloud-embed.php';

		vc_map(
			[
				'name'        => esc_html__( 'SoundCloud Embed', 'social-elements-for-wpbakery' ),
				'base'        => 'sefwpb_soundcloud_embed',
				'description' => esc_html__( 'Embed SoundCloud track or playlist', 'social-elements-for-wpbakery' ),
				'category'    => esc_html__( 'Social', 'social-elements-for-wpbakery' ),
				'icon'        => SEFWPB_ASSETS_URI . '/images/icons/icon-soundcloud-embed.svg',
				'params'      => [
					[
						'type'        => 'textfield',
					...
					[
						'type'        => 'textfield',
						'heading'     => esc_html__( 'SoundCloud URL', 'social-elements-for-wpbakery' ),
						'param_name'  => 'url',
						'description' => esc_html__( 'Enter the URL of the SoundCloud track or playlist you want to embed.', 'social-elements-for-wpbakery' ),
						'value'       => 'https://soundcloud.com/idoymusic/place',
					],
					[
						'type'       => 'dropdown',
					...
					[
						...
						'param_name'  => 'width',
						'group'       => esc_html__( 'Styles', 'social-elements-for-wpbakery' ),
						'description' => esc_html__( 'Optional. Enter width of the embedded player in pixels or percentage. Default is 100%.', 'social-elements-for-wpbakery' ),
						'value'       => '100%',
					],

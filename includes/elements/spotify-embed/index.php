<?php
/**
 * Register the Spotify Embed element for WPBakery.
 *
...
add_action(
	'vc_before_init',
	function () {
		require_once __DIR__ . '/class-sefwpb-element-spotify-embed.php';

		vc_map(
			[
				'name'        => esc_html__( 'Spotify Embed', 'social-elements-for-wpbakery' ),
				'base'        => 'sefwpb_spotify_embed',
				'description' => esc_html__( 'Embed Spotify track, album, or playlist', 'social-elements-for-wpbakery' ),
				'category'    => esc_html__( 'Social', 'social-elements-for-wpbakery' ),
				'icon'        => SEFWPB_ASSETS_URI . '/images/icons/icon-spotify-embed.svg',
				'params'      => [
					[
						'type'        => 'textfield',
					...
					[
						'type'        => 'textfield',
						'heading'     => esc_html__( 'Spotify URL', 'social-elements-for-wpbakery' ),
						'param_name'  => 'url',
						'description' => esc_html__( 'Enter the URL of the Spotify track, album, or playlist you want to embed.', 'social-elements-for-wpbakery' ),

<?php
/**
 * Register the TED Embed element for WPBakery.
 *
...
add_action(
	'vc_before_init',
	function () {
		require_once __DIR__ . '/class-sefwpb-element-ted-embed.php';

		vc_map(
			[
				'name'        => esc_html__( 'TED Embed', 'social-elements-for-wpbakery' ),
				'base'        => 'sefwpb_ted_embed',
				'description' => esc_html__( 'Embed TED talk', 'social-elements-for-wpbakery' ),
				'category'    => esc_html__( 'Social', 'social-elements-for-wpbakery' ),
				'icon'        => SEFWPB_ASSETS_URI . '/images/icons/icon-ted-embed.svg',
				'params'      => [
					[
						'type'        => 'textfield',
					...
					[
						'type'        => 'textfield',
						'heading'     => esc_html__( 'TED URL', 'social-elements-for-wpbakery' ),
						'param_name'  => 'url',
						'description' => esc_html__( 'Enter the URL of the TED talk you want to embed.', 'social-elements-for-wpbakery' ),
						'value'       => 'https://www.ted.com/talks/simon_sinek_how_great_leaders_inspire_action',
					],
					[
						'type'       => 'dropdown',

...
add_action(
	...
	function () {
		...
		vc_map(
			[
				'name'        => esc_html__( 'TikTok Embed', 'social-elements-for-wpbakery' ),
				'base'        => 'sefwpb_tiktok_embed',
				'description' => esc_html__( 'Embed a single TikTok post', 'social-elements-for-wpbakery' ),
				...
				'params'      => [
					...
					[
						'type'        => 'textfield',
						'heading'     => esc_html__( 'TikTok Post URL', 'social-elements-for-wpbakery' ),
						'param_name'  => 'url',
						'description' => esc_html__( 'Enter the URL of the TikTok post you want to embed. Example: https://www.tiktok.com/@adnanjanbaloch7/video/7412994512169192710', 'social-elements-for-wpbakery' ),

...
add_action( 'vc_before_init', function () {
	...
	vc_map(
		[
			'name'              => esc_html__( 'TikTok Embed', SEFWPB_TD ),
			'base'              => 'sefwpb_tiktok_embed',
			'description'       => esc_html__( 'Embed a single TikTok post', SEFWPB_TD ),
			...
			'params'            => [
				...
				[
					'type' => 'textfield',
					'heading' => esc_html__('TikTok Post URL', SEFWPB_TD),
					'param_name' => 'url',
					'description' => esc_html__('Enter the URL of the TikTok post you want to embed. Example: https://www.tiktok.com/@adnanjanbaloch7/video/7412994512169192710', SEFWPB_TD),

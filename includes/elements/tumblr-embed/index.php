<?php
/**
 * Register the Tumblr Embed element for WPBakery.
 *
...
add_action(
	'vc_before_init',
	function () {
		require_once __DIR__ . '/class-sefwpb-element-tumblr-embed.php';

		vc_map(
			[
				'name'        => esc_html__( 'Tumblr Embed', 'social-elements-for-wpbakery' ),
				'base'        => 'sefwpb_tumblr_embed',
				'description' => esc_html__( 'Embed Tumblr post', 'social-elements-for-wpbakery' ),
				'category'    => esc_html__( 'Social', 'social-elements-for-wpbakery' ),
				'icon'        => SEFWPB_ASSETS_URI . '/images/icons/icon-tumblr-embed.svg',
				'params'      => [
					[
						'type'        => 'textfield',
					...
					[
						'type'        => 'textfield',
						'heading'     => esc_html__( 'Tumblr Post URL', 'social-elements-for-wpbakery' ),
						'param_name'  => 'url',
						'description' => esc_html__( 'Enter the URL of the Tumblr post you want to embed.', 'social-elements-for-wpbakery' ),
						'value'       => 'https://www.tumblr.com/nasa/802110516939161600/this-cosmic-spiral-is-coming-out-of-its-shell',
					],
					[
						'type'       => 'dropdown',

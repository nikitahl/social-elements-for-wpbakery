...
add_action(
	...
	function () {
		...
		vc_map(
			[
				'name'        => esc_html__( 'X (Twitter) Embed', 'social-elements-wpbakery' ),
				'base'        => 'sefwpb_twitter_embed',
				'description' => esc_html__( 'Embed X (Twitter) post', 'social-elements-wpbakery' ),
				...
				'params'      => [
					...
					[
						'type'        => 'textfield',
						'heading'     => esc_html__( 'Post (Tweet) URL', 'social-elements-wpbakery' ),
						'param_name'  => 'url',
						'description' => esc_html__( 'Enter the URL of the tweet you want to embed.', 'social-elements-wpbakery' ),

<?php
/**
 * Register the X (Twitter) Embed element for WPBakery.
 *
...
add_action(
	...
	function () {
		...
		vc_map(
			[
				'name'        => esc_html__( 'X (Twitter) Embed', 'social-elements-for-wpbakery' ),
				'base'        => 'sefwpb_twitter_embed',
				'description' => esc_html__( 'Embed X (Twitter) post', 'social-elements-for-wpbakery' ),
				...
				'params'      => [
					...
					[
						'type'        => 'textfield',
						'heading'     => esc_html__( 'Post (Tweet) URL', 'social-elements-for-wpbakery' ),
						'param_name'  => 'url',
						'description' => esc_html__( 'Enter the URL of the tweet you want to embed.', 'social-elements-for-wpbakery' ),

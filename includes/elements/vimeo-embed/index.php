<?php
/**
 * Register the Vimeo Embed element for WPBakery.
 *
...
add_action(
	'vc_before_init',
	function () {
		require_once __DIR__ . '/class-sefwpb-element-vimeo-embed.php';

		vc_map(
			[
				'name'        => esc_html__( 'Vimeo Embed', 'social-elements-for-wpbakery' ),
				'base'        => 'sefwpb_vimeo_embed',
				'description' => esc_html__( 'Embed Vimeo video', 'social-elements-for-wpbakery' ),
				'category'    => esc_html__( 'Social', 'social-elements-for-wpbakery' ),
				'icon'        => SEFWPB_ASSETS_URI . '/images/icons/icon-vimeo-embed.svg',
				'params'      => [
					[
						'type'        => 'textfield',
					...
					[
						'type'        => 'textfield',
						'heading'     => esc_html__( 'Vimeo URL', 'social-elements-for-wpbakery' ),
						'param_name'  => 'url',
						'description' => esc_html__( 'Enter the URL of the Vimeo video you want to embed.', 'social-elements-for-wpbakery' ),
						'value'       => 'https://vimeo.com/347119375',
					],
					[
						'type'       => 'dropdown',

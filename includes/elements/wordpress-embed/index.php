...
add_action(
	...
	function () {
		...
		vc_map(
			[
				'name'        => esc_html__( 'WordPress Embed', 'social-elements-for-wpbakery' ),
				'base'        => 'sefwpb_wordpress_embed',
				'description' => esc_html__( 'Embed WordPress post/page', 'social-elements-for-wpbakery' ),
				...
				'params'      => [
					...
					[
						'type'        => 'vc_link',
						'heading'     => esc_html__( 'Post URL', 'social-elements-for-wpbakery' ),
						'param_name'  => 'url',
						'description' => esc_html__( 'Enter the URL of the post you want to embed.', 'social-elements-for-wpbakery' ),
						'value'       => '',
					],
					[
						'type'       => 'dropdown',

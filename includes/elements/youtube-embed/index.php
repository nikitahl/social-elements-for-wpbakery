<?php
/**
 * Register the YouTube Embed element for WPBakery.
 *
...
add_action(
	'vc_before_init',
	function () {
		require_once __DIR__ . '/class-sefwpb-element-youtube-embed.php';

		vc_map(
			[
				'name'        => esc_html__( 'YouTube Embed', 'social-elements-for-wpbakery' ),
				'base'        => 'sefwpb_youtube_embed',
				'description' => esc_html__( 'Embed YouTube video', 'social-elements-for-wpbakery' ),
				'category'    => esc_html__( 'Social', 'social-elements-for-wpbakery' ),
				'icon'        => SEFWPB_ASSETS_URI . '/images/icons/icon-youtube-embed.svg',
				'params'      => [
					[
						'type'        => 'textfield',
					...
					[
						'type'        => 'textfield',
						'heading'     => esc_html__( 'YouTube URL', 'social-elements-for-wpbakery' ),
						'param_name'  => 'url',
						'description' => esc_html__( 'Enter the URL of the YouTube video you want to embed.', 'social-elements-for-wpbakery' ),
						'value'       => 'https://youtu.be/3S-s_V_z8JQ',
					],
					[
						'type'       => 'dropdown',
